...
export function ProjectCard({
  ...
  async function updateProject(method: "PATCH" | "DELETE") {
    setPending(true);
    try {
      ...
      onError(
        method === "DELETE"
          ...
          : `No se pudo ${p.archivedAt ? "desarchivar" : "archivar"} el proyecto. Inténtalo de nuevo.`,
      );
    } finally {
      setPending(false);
    }
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        pending={pending}
        onConfirm={() => void updateProject("DELETE")}
